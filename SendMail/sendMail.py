...
def main():
    # 请自行修改下面的邮件发送者和接收者
    sender = 'keyoung.lau@qq.com'  # 发送者的邮箱地址
    receivers = ['610856109@qq.com']  # 接收者的邮箱地址
    text = """
...
这样，我们在阳光下，向着那菜花、桑树和鱼塘走去。到了一处，我蹲下来，背起了母亲，妻子也蹲下来，背起了儿子。我的母亲虽然高大，然而很瘦，自然不算重；儿子虽然很胖，毕竟幼小，自然也轻。但我和妻子都是慢慢地，稳稳地，走得很仔细，好像我背上的同她背上的加起来，就是整个世界。
    ...
    message['From'] = Header('Keyoung.lau', 'utf-8')  # 邮件的发送者
    message['To'] = Header('Hua.li', 'utf-8')  # 邮件的接收者
    message['Subject'] = Header('散步', 'utf-8')  # 邮件的标题
    smtper = SMTP('smtp.qq.com')
    # 请自行修改下面的登录口令
    smtper.login(sender, 'vlmkaiceiltfbeia')  # QQ邮箱smtp的授权码
